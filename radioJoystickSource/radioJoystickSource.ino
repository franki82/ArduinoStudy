...
int buttonVideoView = 6, buttonVideoViewState = 0, useVideoView = -1;
...
void setup() {
  ...
  pinMode(buttonVideoView, INPUT_PULLUP);
...
void loop() {
  ...
  buttonVideoViewState = digitalRead(buttonVideoView);
  ...
  if (buttonVideoViewState == LOW){
    useVideoView = 1;
  } else if (buttonVideoViewState == HIGH){
    useVideoView = -1;
  }
